...
from reinvent_scoring.scoring.score_components import TanimotoSimilarity, \
    ...
    FormalCharge, MaxSim, MinSim, Simp, Simsdiff #MUBDadd
...
class ScoreComponentFactory:
    ...
    def _deafult_scoring_component_registry(self) -> dict:
        ...
        component_map = {
            ...
            enum.ICOLOS: Icolos,
            enum.FORMAL_CHARGE: FormalCharge,#MUBDadd
            enum.MAX_SIM: MaxSim,#MUBDadd
            enum.MIN_SIM: MinSim,#MUBDadd
            enum.SIMP: Simp,#MUBDadd
            enum.SIMSDIFF: Simsdiff,#MUBDadd
