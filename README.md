...
2. The criteria (or rule) for an ideal decoy previously defined in MUBD-DECOYMAKER are integrated into a new scoring function for RL to fine-tune the generator.
